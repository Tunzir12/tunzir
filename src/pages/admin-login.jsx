  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-100 via-neutral-50 to-white dark:bg-gradient-to-b dark:from-fuchsia-900 dark:via-blue-950 dark:to-gray-900 dark:text-white">
      ...
      <div className="min-h-screen flex items-center justify-center pt-20 px-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-12 max-w-md w-full">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white font-semibold rounded-lg transition duration-300 mb-6"
          >
